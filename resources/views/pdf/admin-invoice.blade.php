                    ...
                    <td style="width: 42%;">
                        ...
                        <table class="meta-table">
                            ...
                            <tr>
                                ...
                                <td class="meta-value">{{ $invoice->issue_date?->format('M d, Y') ?: ($invoice->created_at?->format('M d, Y')) }}</td>
                            </tr>
        ...
        <div class="bill-box">
            <table class="header-table">
                <tr>
                    ...
                    <td style="width: 50%; border-left: 1px solid #e2e8f0; padding-left: 16px; vertical-align: top;">
