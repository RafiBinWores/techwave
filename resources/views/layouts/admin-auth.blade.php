...
<body class="min-h-screen bg-[#0f172a] text-slate-100 antialiased">
    ...
    <div class="relative min-h-screen overflow-hidden bg-slate-50 dark:bg-[#0f172a]">
        <div
            class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.16),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(14,165,233,0.12),transparent_28%)]">
        </div>
