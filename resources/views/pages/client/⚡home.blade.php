                    ...
                    <div class="relative mx-auto h-125 w-full max-w-155 sm:h-140">
                        ...
                        <div
                            ...
                            <div class="md:p-3">
                                ...
                                <p class="mt-1 text-[10px] md:text-xs text-blue-100/65">Strong ideas. Clear direction.</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="md:p-3">
                                ...
                                <p class="mt-1 text-[10px] md:text-xs text-blue-100/65">Built around real growth goals.</p>
                            </div>
                        </div>
                        ...
                        <div class="absolute bottom-16 right-10 h-28 w-28 rounded-full bg-blue-500/20 blur-3xl"></div>

                        <!-- dots -->
                        <div class="absolute left-[20%] top-[20%] h-3 w-3 rounded-full bg-cyan-300 animate-ping"></div>
                        <div
    ...
    <section class="relative overflow-hidden py-10 md:py-15 lg:py-24">
        <div class="mx-auto max-w-350 px-4 sm:px-6 lg:px-8">
            <div class="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
                ...
                <!-- Right Animated Images -->
                <div class="relative order-1 lg:order-2">
                    <div class="relative mx-auto h-125 w-full max-w-155 sm:h-[560px]">
                        <!-- main image -->
                        <div
                            class="absolute left-1/2 top-1/2 w-[72%] -translate-x-1/2 -translate-y-1/2 animate-[floatY_6s_ease-in-out_infinite] rounded-[28px] border border-white/15 bg-white/10 p-3 shadow-[0_20px_60px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
                            <div class="overflow-hidden rounded-[22px]">
                                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80"
                                    alt="Team collaboration" class="h-[340px] w-full object-cover sm:h-[400px]" />
                            </div>
                        </div>

                        <!-- top left card -->
                        <div
                            class="absolute left-0 top-10 w-40 animate-[floatY_5s_ease-in-out_infinite] rounded-[22px] border border-white/15 bg-white/10 p-2 shadow-[0_15px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:w-48">
                            <div class="overflow-hidden rounded-[18px]">
                                <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=800&q=80"
                                    alt="Creative workspace" class="h-28 w-full object-cover sm:h-32" />
                            </div>
                            <div class="p-3">
                                <p class="text-sm font-semibold text-white">Creative Strategy</p>
                                <p class="mt-1 text-xs text-blue-100/65">Strong ideas. Clear direction.</p>
                            </div>
                        </div>

                        <!-- top right card -->
                        <div
                            class="absolute right-0 top-4 w-44 animate-[floatY_7s_ease-in-out_infinite] rounded-[22px] border border-white/15 bg-white/10 p-2 shadow-[0_15px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:w-52">
                            <div class="overflow-hidden rounded-[18px]">
                                <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80"
                                    alt="Business planning" class="h-32 w-full object-cover sm:h-36" />
                            </div>
                            <div class="p-3">
                                <p class="text-sm font-semibold text-white">Business Planning</p>
                                <p class="mt-1 text-xs text-blue-100/65">Built around real growth goals.</p>
                            </div>
                        </div>

                        <!-- bottom left small -->
                        <div
                            class="absolute bottom-10 left-6 w-36 animate-[floatY_6.5s_ease-in-out_infinite] rounded-[20px] border border-white/15 bg-white/10 p-2 shadow-[0_15px_35px_rgba(0,0,0,0.25)] backdrop-blur-xl sm:w-40">
                            <div class="overflow-hidden rounded-2xl">
                                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80"
                                    alt="Analytics dashboard" class="h-24 w-full object-cover sm:h-28" />
                            </div>
                        </div>

                        <!-- bottom right small -->
                        <div
                            class="absolute bottom-6 right-8 w-36 animate-[floatY_5.5s_ease-in-out_infinite] rounded-[20px] border border-white/15 bg-white/10 p-2 shadow-[0_15px_35px_rgba(0,0,0,0.25)] backdrop-blur-xl sm:w-40">
                            <div class="overflow-hidden rounded-2xl">
                                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80"
                                    alt="Technology development" class="h-24 w-full object-cover sm:h-28" />
                            </div>
                        </div>
