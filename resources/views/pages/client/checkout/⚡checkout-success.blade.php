...
<section class="min-h-screen px-4 py-20 text-white">
    <div class="mx-auto max-w-2xl rounded-3xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-xl">
        ...
        <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a href="{{ route('success.invoice.download', $order) }}"
                class="inline-flex items-center justify-center gap-2 rounded-full bg-linear-to-r from-emerald-500 to-teal-400 px-6 py-3 font-semibold text-white shadow-lg shadow-emerald-500/20 transition hover:-translate-y-0.5">
