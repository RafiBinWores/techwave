                ...
                <div class="min-w-0 flex-1 p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="mb-8 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-blue-100/60">Manage your active and past tool subscriptions.</p>
                        </div>
                    </div>
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            <h3 class="text-base font-bold text-white">
                                                {{ $sub->toolCategory?->name ?? 'Unknown' }}
                                            </h3>
                                            <span @class([ 'text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full' , 'bg-emerald-500/15 text-emerald-300'=> $sub->status === 'active',
                        ...
                        <div class="text-right">
                            ...
                            <div class="mt-2 space-y-0.5 text-xs text-slate-400">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <span @class([ 'font-bold' , 'text-emerald-300'=> strtolower($previewInvoice->status ?? '') === 'paid',
