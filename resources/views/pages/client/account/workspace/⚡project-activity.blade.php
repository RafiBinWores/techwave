                        ...
                        <div class="flex min-w-0 items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-3xl font-extrabold tracking-tight sm:text-4xl">
                                    My
                                    <span class="bg-linear-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent">Profile</span>
                                </h1>
                        ...
                        <div
                            ...
                            <div class="mt-6 flex flex-col items-center text-center">
                                <div
                                    ...
                                    @elseif ($avatar)
                                    <img src="{{ \App\Services\UploadStorage::url($avatar) }}"
                                        class="h-full w-full object-cover">
                                    @else
                                    <div
                            ...
                            <div class="mt-6 flex flex-col items-center text-center">
                                <div
                                    ...
                                    <img src="{{ $logoFile->temporaryUrl() }}"
                                        class="h-full w-full object-cover">
                                    @elseif ($company_logo)
                                    <img src="{{ \App\Services\UploadStorage::url($company_logo) }}"
                                        class="h-full w-full object-cover">
                                    @else
                                    <div
