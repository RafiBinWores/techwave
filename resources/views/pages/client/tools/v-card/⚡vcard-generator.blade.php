...
new #[Title('VCard Generator')] class extends Component {
    ...
    */
    ...
    public function loadVcard(int $id): void
    {
        ...
        $this->profilePreview = $vcard->profile_path ? \App\Services\UploadStorage::url($vcard->profile_path) : null;
        $this->bannerPreview = $vcard->banner_path ? \App\Services\UploadStorage::url($vcard->banner_path) : null;
        $this->loadingImagePreview = $vcard->loading_path ? \App\Services\UploadStorage::url($vcard->loading_path) : null;
        ...
        $this->qrLogoPreview = $vcard->qr_logo_path ? \App\Services\UploadStorage::url($vcard->qr_logo_path) : null;
    ...
    private function resolveQrLogoPath(Vcard $vcard): ?string
    {
        ...
        if ($mode === 'custom') {
            ...
            if ($vcard->qr_logo_path) {
                return \App\Services\UploadStorage::dataUri($vcard->qr_logo_path);
            }
    ...
    private function getSiteLogoPath(): ?string
    {
        ...
        return \App\Services\UploadStorage::dataUri($logo);
    }
...
<div class="vcard-builder min-h-screen text-white" x-data="{
    ...
    <section class="mx-auto max-w-350 px-4 py-10 sm:px-6 lg:px-8">
        <div class="relative mb-6 text-center sm:mb-10">
            <h1 class="mt-2 text-xl font-black tracking-tight sm:mt-4 sm:text-5xl">VCard
