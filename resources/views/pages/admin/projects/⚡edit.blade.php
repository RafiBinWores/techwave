...
new #[Layout('layouts.admin-app')] #[Title('Edit Project')] class extends Component {
    use WithFileUploads;
    ...
    public function mount(Project $project): void
    {
        ...
        $this->client_place = $project->client_place ?? '';
    ...
    protected function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:220', Rule::unique('projects', 'slug')->ignore($this->project->id)],
    ...
    public function update(): void
    {
        ...
        $thumbnailPath = $this->project->thumbnail;
        ...
        $this->project->update([
            ...
            'slug' => Str::slug($this->slug ?: $validated['title']),
    ...
    public function discard(): void
    {
        ...
        $this->client_place = $this->project->client_place ?? '';
        ...
        $this->live_url = $this->project->live_url ?? '';
        $this->case_study_url = $this->project->case_study_url ?? '';
        $this->completed_at = $this->project->completed_at?->format('Y-m-d') ?? '';
        ...
        $this->is_featured = (bool) $this->project->is_featured;
...
<div>
    <div class="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-h1 font-h1 text-on-surface">Edit Project</h1>
            <p class="mt-1 text-body-md font-body-md text-secondary">
                Update completed project information, client details, thumbnail, links and SEO data.
            </p>
        </div>
