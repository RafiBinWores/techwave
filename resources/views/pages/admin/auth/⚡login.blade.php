        ...
        <div class="relative z-10 flex min-h-screen w-full flex-col justify-between p-10 xl:p-14">
            <div>
                <a href="{{ route('home') }}" class="inline-flex items-center gap-3">
                    <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/10 backdrop-blur-xl">
            ...
            <div class="max-w-md">
                <div class="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium text-blue-100 backdrop-blur-xl">
                ...
                <p class="mt-5 max-w-md text-base leading-7 text-slate-300">
                    Manage your platform, monitor business activity, and control users, services, and operations from one modern dashboard.
                </p>
    ...
    <section class="relative flex min-h-screen flex-1 items-center justify-center px-4 py-10 sm:px-6 lg:px-10">
        <div class="w-full max-w-117.5">
            <div class="mb-8 text-center lg:hidden">
                <a href="{{ route('home') }}" class="inline-flex items-center gap-3">
                    <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-blue-600 shadow-lg shadow-blue-600/25">
                        <svg viewBox="0 0 32 32" class="h-6 w-6 fill-white">
                            <path d="M16 3l10 6v14l-10 6L6 23V9l10-6zm0 3.3L9 10.2v11.6l7 3.9 7-3.9V10.2l-7-3.9z"/>
                        </svg>
                    </div>
            ...
            <div class="rounded-[28px] border border-slate-200/70 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-8 dark:border-white/10 dark:bg-white/4 dark:shadow-[0_25px_70px_rgba(0,0,0,0.35)]">
                <div class="mb-8">
                ...
                <form wire:submit.prevent="login" class="space-y-5">
                    <div>
                        <label for="email" class="mb-2.5 block text-sm font-medium text-slate-700 dark:text-slate-200">
                            Email
                        </label>
                        ...
                        <div class="relative">
                            <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5A2.25 2.25 0 0119.5 19.5h-15A2.25 2.25 0 012.25 17.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15A2.25 2.25 0 002.25 6.75m19.5 0v.243a2.25 2.25 0 01-1.07 1.92l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.913a2.25 2.25 0 01-1.07-1.92V6.75" />
                                </svg>
                            </span>
                        ...
                        <div class="relative">
                            ...
                            >
                                <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.644C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.437 0 .644C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.964-7.178z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>

                                <svg x-show="show" style="display:none;" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m3 3 18 18" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.477 10.483A3 3 0 0013.5 13.5" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.88 4.24A10.966 10.966 0 0112 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.437 0 .644a11.052 11.052 0 01-4.293 5.284M6.228 6.228A11.05 11.05 0 002.036 11.678a1.012 1.012 0 000 .644C3.423 16.49 7.36 19.5 12 19.5c1.62 0 3.158-.367 4.534-1.023" />
                                </svg>
                            </button>
                        </div>
