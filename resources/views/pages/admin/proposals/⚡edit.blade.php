...
<div>
    <div class="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-h1 font-h1 text-on-surface">Edit Proposal</h1>
            <p class="mt-1 text-body-md font-body-md text-secondary">
                Edit a custom proposal with multiple services, plans, discounts and customer details.
            </p>
        </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea wire:model.live="terms" rows="5" class="w-full rounded border border-outline-variant px-4 py-2.5"
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                        ...
                        <button type="submit" x-data x-on:click="$store.phoneInputs.syncAll()" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove wire:target="update">Update Proposal</span>
