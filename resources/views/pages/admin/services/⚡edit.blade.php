    ...
    <div class="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-body-md font-body-md text-secondary">
                Update service content, SEO information, visibility and featured status.
            </p>
        </div>
    ...
    <form wire:submit.prevent="update">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 space-y-6 lg:col-span-8">
                ...
                <!-- Target Audience -->
                <div class="grid grid-cols-1 gap-6 rounded-xl border border-blue-50 bg-[#F8FAFC] p-6 md:grid-cols-2">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <textarea wire:model="audience_detail" class="w-full rounded border border-outline-variant bg-white px-3 py-2 text-sm"
