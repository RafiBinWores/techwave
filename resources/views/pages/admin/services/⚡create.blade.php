...
new #[Layout('layouts.admin-app')] #[Title('Create Service')] class extends Component {
    ...
    {
        $this->reset(['category_id', 'card_title', 'detail_title', 'icon', 'short_description', 'overview', 'audience_title', 'audience_detail', 'meta_title', 'meta_description', 'meta_keywords', 'image', 'included_items', 'included_item', 'tags', 'tag', 'media_type', 'media_color', 'media_gradient_from', 'media_gradient_to', 'media_gradient_angle']);
        ...
        $this->show_in_navbar = false;
        $this->show_short_description = true;
