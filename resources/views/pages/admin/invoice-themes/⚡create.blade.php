...
new #[Layout('layouts.admin-app')] #[Title('Add Invoice Theme')] class extends Component {
    ...
    protected function rules(): array
    {
        return [
            ...
            // Custom CSS is allowed per theme, but no external url/import.
                        ...
                        <label
                            ...
                            @if ($preview)
                                <img src="{{ $preview->temporaryUrl() }}"
                                    class="aspect-[4/3] w-full rounded-lg object-cover" alt="Theme preview">
                            @else
                        ...
                        <label
                            ...
                            @if ($pdf_background)
                                <img src="{{ $pdf_background->temporaryUrl() }}"
                                    class="aspect-[210/297] w-full object-cover" alt="PDF background preview">
                            @else
        ...
        <section class="space-y-6 rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div x-data="{ copied: null }" class="rounded-xl border border-blue-200 bg-blue-50 p-4">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <div class="flex gap-2">
                        <button type="button" wire:click="useRedAccentTemplate"
                            ...
                            class="text-xs font-semibold text-red-600">Use red accent design</button>
                ...
                <p class="mt-1 text-xs leading-5 text-slate-600">
                    ...
                    Use smart blocks like <code class="font-mono">@{{ seller_contact_block }}</code>,
                    <code class="font-mono">@{{ invoice_date_block }}</code>,
                    <code class="font-mono">@{{ shipping_row }}</code>, and
                    <code class="font-mono">@{{ discount_row }}</code> to avoid empty spaces.
                </p>
    ...
    "
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-secondary">Paste the HTML div that contains your theme markup with
                        placeholders.</p>
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-secondary">Paste the CSS styles for your theme. Do not include
