...
new #[Layout('layouts.admin-app')] #[Title('Create Category')] class extends Component {
    use WithFileUploads;
...
<div>
    <div class="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-h1 font-h1 text-on-surface">Create Category</h1>
            <p class="mt-1 text-body-md font-body-md text-secondary">
                Create a category to organize website content, services, or products.
            </p>
        </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input type="text" wire:model.live="name" placeholder="Example: Domain & Hosting"
