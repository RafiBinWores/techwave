        ...
        <tr>
            <td align="center">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td valign="top" align="right" style="width:45%;">
                                        <h2
                                            style="margin:0 0 16px; font-size:32px; line-height:1; color:{{ $brandColor }}; font-weight:800;">
                                            PROPOSAL
                                        </h2>

                                        <table cellpadding="0" cellspacing="0"
                                            style="margin-left:auto; font-size:13px; color:#475569;">
                                            <tr>
                                                <td
                                                    style="padding:3px 16px 3px 0; text-transform:uppercase; color:#94a3b8; font-size:11px; letter-spacing:.08em;">
                                                    Proposal #
                                                </td>
                                                <td
                                                    style="padding:3px 0; font-weight:700; color:#111827; text-align:right;">
                                            ...
                                            @if ($proposal->valid_until)
                                                <tr>
                                                    ...
                                                    <td
                                                        style="padding:3px 0; text-align:right; font-weight:700; color:{{ $brandColor }};">
                    ...
                    <tr>
                        <td style="padding:20px 30px 0;">
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                ...
                                <tbody
                                    style="border-left:1px solid #e5e7eb; border-right:1px solid #e5e7eb; border-bottom:1px solid #e5e7eb;">
                                    @foreach ($proposal->items as $index => $item)
                                        ...
                                        <tr style="background:{{ $rowBg }};">
                                            ...
                                            <td align="center" valign="top"
                                                style="padding:15px 14px; border-top:1px solid #e5e7eb; font-size:13px; color:#334155;">
                                            ...
                                            <td align="right" valign="top"
                                                style="padding:15px 14px; border-top:1px solid #e5e7eb; font-size:13px; font-weight:700; color:#111827;">
                                    ...
                                    <td valign="top" style="width:45%;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="right"
                                                    style="padding:6px 0; font-size:14px; color:#111827;">
                ...
                <p style="margin:16px 0 0; font-size:11px; color:#94a3b8;">
                    Thank you for considering our proposal. We look forward to the opportunity to work with you and help
