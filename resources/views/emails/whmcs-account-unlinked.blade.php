...
<head>
    ...
    <title>Billing Account Unlinked</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; background:#0f172a; border:1px solid rgba(255,255,255,0.08); border-radius:28px; overflow:hidden;">
                    <tr>
                        <td style="padding:40px 36px 16px; text-align:center;">
                            <div style="display:inline-block; padding:8px 14px; border-radius:999px; background:rgba(251,146,60,0.12); color:#fdba74; font-size:12px; font-weight:700; letter-spacing:0.5px;">
                                ACCOUNT SECURITY
                            </div>

                            <h1 style="margin:18px 0 12px; color:#ffffff; font-size:30px; line-height:1.25;">
                                Billing account unlinked
                            </h1>

                            <p style="margin:0; color:#cbd5e1; font-size:15px; line-height:1.8;">
                                Hi {{ $user->name }},<br>
                                your WHMCS billing account (<strong style="color:#ffffff;">{{ $whmcsEmail }}</strong>) has been unlinked from your portal account by an administrator.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 36px 22px;">
                            <div style="background:rgba(251,146,60,0.06); border:1px solid rgba(251,146,60,0.2); border-radius:18px; padding:18px;">
                                ...
                                <p style="margin:0; color:#94a3b8; font-size:14px; line-height:1.7;">
                                    You will no longer be able to view WHMCS invoices or billing information from your portal. If this was a mistake, you can relink your billing account from the <strong style="color:#cbd5e1;">Link Billing Account</strong> page in your account settings.
                                </p>
                            </div>
                        </td>
                    </tr>
