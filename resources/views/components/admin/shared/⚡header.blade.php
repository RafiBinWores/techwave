            ...
            <div x-cloak x-show="notificationOpen" @click.outside="notificationOpen = false"
                ...
                <div class="max-h-80 overflow-y-auto divide-y divide-slate-100">
                    <a href="#" class="flex gap-3 px-4 py-3 hover:bg-slate-50 transition">
                        <div
                            class="h-9 w-9 rounded-xl bg-blue-100 text-blue-700 flex items-center justify-center shrink-0">
                    ...
                    <a href="#" class="flex gap-3 px-4 py-3 hover:bg-slate-50 transition">
                        <div
                            class="h-9 w-9 rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center shrink-0">
                    ...
                    <a href="#" class="flex gap-3 px-4 py-3 hover:bg-slate-50 transition">
                        <div
                            class="h-9 w-9 rounded-xl bg-red-100 text-red-700 flex items-center justify-center shrink-0">
