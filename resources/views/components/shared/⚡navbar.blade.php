    ...
    <nav class="glass-panel rounded-2xl px-4 py-4 sm:px-6" x-data="{ mobileMenu: false, userMenu: false }">
        <div class="flex items-center justify-between gap-4">
            <a href="{{ route('home') }}" wire:navigate class="flex items-center gap-3">
                <img
                    src="https://techwave.asia/storage/services/light-logo-142x75.png"
                    alt="Logo"
            ...
            <div class="hidden items-center gap-8 text-sm font-medium text-blue-50/85 lg:flex">
                ...
                <a href="{{ route('client.services') }}" wire:navigate class="transition hover:text-white">Services</a>
                <a href="{{ route('client.tools.index') }}" wire:navigate class="transition hover:text-white">Tools</a>
                <a href="{{ route('client.blogs.index') }}" wire:navigate class="transition hover:text-white">Blogs</a>
                <a href="{{ route('client.about') }}" wire:navigate class="transition hover:text-white">About</a>
                <a href="{{ route('client.contact') }}" wire:navigate class="transition hover:text-white">Contact</a>
            </div>
                        ...
                        >
                            ...
                            <form wire:submit.prevent="logout">
                                <button
                                    ...
                                    class="block w-full rounded-xl px-4 py-3 text-left text-sm text-red-300 transition hover:bg-red-500/15 disabled:opacity-60"
                                >
        ...
        >
            <div class="flex flex-col gap-3 text-sm text-blue-50/85">
                ...
                <a href="{{ route('client.services') }}" wire:navigate class="glass-soft rounded-xl px-4 py-3">Services</a>
                <a href="{{ route('client.tools.index') }}" wire:navigate class="glass-soft rounded-xl px-4 py-3">Tools</a>
                <a href="{{ route('client.blogs.index') }}" wire:navigate class="glass-soft rounded-xl px-4 py-3">Blogs</a>
                <a href="{{ route('client.about') }}" wire:navigate class="glass-soft rounded-xl px-4 py-3">About</a>
                <a href="{{ route('client.contact') }}" wire:navigate class="glass-soft rounded-xl px-4 py-3">Contact</a>
