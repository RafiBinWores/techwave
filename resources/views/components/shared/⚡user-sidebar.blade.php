...
new class extends Component {
    ...
    {
        return auth()->check() && auth()->user()->toolSubscriptions()->active()->exists();
    }

    public function getHasWhmcsAccountProperty(): bool
    {
        return auth()->check() && auth()->user()->whmcsAccount()->exists();
    }
};
?>
...
<aside
    ...
    class="fixed left-4 top-4 bottom-4 z-50 w-71.25 rounded-2xl border border-white/10 bg-slate-950/90 p-5 backdrop-blur-2xl transition-all duration-300 lg:static lg:w-70 lg:translate-x-0 lg:rounded-none lg:border-0 lg:border-r lg:bg-slate-950/35 ">
    ...
    <div class="flex h-full flex-col">
        ...
        <!-- nav -->
        <nav class="mt-8 flex-1 space-y-7 overflow-y-auto">

            {{-- Overview --}}
            <div class="space-y-1">
                <p class="px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-blue-100/35">Overview</p>
            ...
            {{-- Products --}}
            <div class="space-y-1">
                <p class="px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-blue-100/35">Services & Tools</p>

                <div x-data="{ productsOpen: false }" class="space-y-1">
                    <button @click="productsOpen = !productsOpen" type="button"
                        class="client-dash-link w-full cursor-pointer">
                        <span class="client-dash-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M8 21h8" />
                        ...
                        <span>My Services & Tools</span>
                        <svg :class="productsOpen ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg"
                            class="ml-auto h-4 w-4 transition-transform duration-200" viewBox="0 0 24 24"
                    ...
                    <div x-show="productsOpen" @click.outside="productsOpen = false"
                        ...
                        <a href="{{ route('account.services') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="{{ route('account.invoices') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('account.workspace-projects') }}" wire:navigate wire:current.exact="client-dash-link-active"
                    class="client-dash-link">
                    <span class="client-dash-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div x-data="{ toolsBackupOpen: false }" class="space-y-1">
                    ...
                    <div x-show="toolsBackupOpen" @click.outside="toolsBackupOpen = false"
                        x-transition:enter="transition ease-out duration-200"
                        x-transition:enter-start="opacity-0 -translate-y-1"
                        x-transition:enter-end="opacity-100 translate-y-0"
                        x-transition:leave="transition ease-in duration-150"
                        ...
                        <a href="{{ route('account.pdf-files') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            {{-- Billing --}}
            <div class="space-y-1">
                <p class="px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-blue-100/35">Billing</p>

                <div x-data="{ whmcsOpen: false }" class="space-y-1">
                    <button @click="whmcsOpen = !whmcsOpen" type="button"
                        class="client-dash-link w-full cursor-pointer">
                        <span class="client-dash-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <svg :class="whmcsOpen ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div x-show="whmcsOpen" @click.outside="whmcsOpen = false"
                        x-transition:enter="transition ease-out duration-200"
                        x-transition:enter-start="opacity-0 -translate-y-1"
                        x-transition:enter-end="opacity-100 translate-y-0"
                        x-transition:leave="transition ease-in duration-150"
                        ...
                        @if ($this->has_whmcs_account)
                        <a href="{{ route('account.whmcs.sso') }}" target="_blank" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                        ...
                        <a href="{{ route('account.billing-invoices') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a href="{{ route('account.billing-services') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a href="{{ route('account.domains') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            {{-- Support --}}
            <div class="space-y-1">
                <p class="px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-blue-100/35">Support</p>
            ...
            {{-- Account --}}
            <div class="space-y-1">
                <p class="px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-blue-100/35">Account</p>
                ...
                <div x-data="{ settingsOpen: false }" class="space-y-1">
                    <button @click="settingsOpen = !settingsOpen" type="button"
                        ...
                        <span>Settings</span>
                        <svg :class="settingsOpen ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg"
                            class="ml-auto h-4 w-4 transition-transform duration-200" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="6 9 12 15 18 9" />
                        </svg>
                    ...
                    <div x-show="settingsOpen" @click.outside="settingsOpen = false"
                        ...
                        <a href="{{ route('account.link-whmcs') }}" wire:navigate
                            ...
                            <span>Link Billing Account</span>
                        </a>
                        ...
                        <a href="{{ route('account.delete-account') }}" wire:navigate
                            wire:current.exact="client-dash-link-active" class="client-dash-link">
                            <span class="client-dash-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
