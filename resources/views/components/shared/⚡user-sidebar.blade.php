...
<aside
    ...
    <nav class="mt-8 flex-1 space-y-2">
        ...
        <a href="{{ route('account.tool-subscriptions') }}" wire:navigate wire:current.exact="client-dash-link-active"
            class="client-dash-link">
            <span class="client-dash-icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-toolbox-icon lucide-toolbox">
                    <path d="M16 12v4" />
        ...
        <div x-data="{ whmcsOpen: false }" class="space-y-1">
            ...
            <div x-show="whmcsOpen" @click.outside="whmcsOpen = false"
                ...
                <a href="{{ route('account.billing-invoices') }}" wire:navigate
                    wire:current.exact="client-dash-link-active"
                    class="client-dash-link">
                    <span class="client-dash-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
